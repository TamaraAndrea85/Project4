...
import { verifyAccountAction } from "../../../redux/slices/accountVarification/AccVarificationSlices";
  ...
  return (
    <>
      {verified ? (
        ...
        <div className="flex justify-center bg-blue-300 items-center min-h-screen">
          <Link
            to="/"
            type="button"
            className="inline-flex justify-center  rounded-md border border-transparent shadow-sm px-4 py-2 bg-indigo-500 text-base font-medium text-white hover:bg-indigo-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-indigo-500 sm:text-sm"
          >
            Go Home
          </Link>
        </div>
