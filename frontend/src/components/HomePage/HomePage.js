          ...
          <div className="flex flex-wrap items-center -mx-4 mb-10 2xl:mb-14">
            <div className="w-full lg:w-1/2 px-4 mb-16 lg:mb-0">
              <span className="text-lg font-bold text-blue-400">
                Something here about the site
              </span>
              <h2 className="max-w-2xl mt-12 mb-12 text-6xl 2xl:text-8xl text-white font-bold font-heading">
                Share your expirences{" "}
                <span className="text-grey-500">By creating a post</span>
              </h2>
              <p className="mb-12 lg:mb-16 2xl:mb-24 text-xl text-gray-100">
                Natural hair health and wellness...
              </p>
              <a
                className="inline-block px-12 py-5 text-lg text-blue font-bold bg-blue-500 hover:bg-grey-600 rounded-full transition duration-200"
                href="/"
              >
                Enter Site
              </a>
